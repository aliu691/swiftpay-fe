...
export default function GroupProgressCard({
  ...
  return (
    <div className="lg:col-span-2 bg-white p-8 rounded-3xl border-gray-200 border-2 border-dashed">
      {/* Header Row */}
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-lg text-gray-500">Savings Progress</h3>
      ...
      {percentage === 100 && status === "disbursed" && (
        <div className="flex items-center gap-2 mt-6 text-green-600 font-medium">
